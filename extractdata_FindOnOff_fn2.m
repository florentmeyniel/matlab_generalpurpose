function [EffortDur, RestDur, FB, PERF]=extractdata_FindOnOff_fn2(opt)
%
...
% USAGE
% -----
% [EffortDur, RestDur, FB, PERF] = extractdata_FindOnOff_fn2(opt)
%
% OPTIONS TO DEFINE
% ----------------
% 
...
%
%
% CHANGE FROM VERSION 1, in FindOnOff2
        ...
        for block = blocks_list
            ...
            for ntrial = trial_list
                ...
                [trialEffortDur, trialRestDur] = ...
                    SplitRestEffort2(data.gripdata{ntrial}, ...
                    method, ...
                    ON2OFFDeadtime, ...
                    OFF2ONDeadtime, ...
                    thd, ...
